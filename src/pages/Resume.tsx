          ...
          <div className="space-y-8">
            ...
            <section className="group">
              ...
              <ul className="space-y-2 md:space-y-2.5 text-xs md:text-sm text-gray-400">
                ...
                <li className="flex gap-2">
                  <span className="text-blue-400/50 mt-0.5 flex-shrink-0">→</span>
                  <span>PublicBodies Datathon 2025 – Data validation for civic tech</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-blue-400/50 mt-0.5 flex-shrink-0">→</span>
                  <span>Volunteer Recruitment Platform – KEC Hack-a-LITE 2024</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-blue-400/50 mt-0.5 flex-shrink-0">→</span>
                  <span>Local Produce Marketplace – KIST HackFest 2023</span>
                </li>
              </ul>
            </section>
            ...
            <section className="group">
              ...
              <div className="space-y-3 md:space-y-4 text-xs md:text-sm">
                ...
                <div className="bg-slate-900/30 p-3 md:p-4 rounded hover:bg-slate-900/50 transition-colors">
                  <p className="text-gray-300 font-medium">Sustainability Mentorship 2025 - Mentee</p>
            ...
            <section className="group">
              ...
              <ul className="space-y-1.5 md:space-y-2 text-xs text-gray-400">
                <li className="flex gap-2"><span className="text-blue-400/50 flex-shrink-0">•</span> <span>APIGA Nepal 2025</span></li>
            ...
            <section className="group">
              ...
              <p className="text-xs md:text-sm text-gray-400">Civic tech, climate communication, youth leadership, community innovation, public speaking,photography , and visual storytelling.</p>
            </section>
